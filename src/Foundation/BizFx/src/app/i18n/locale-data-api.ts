...
import {LOCALE_DATA, LocaleDataIndex, ExtraLocaleDataIndex} from './locale-data';

/*
 * The different format styles that can be used to represent numbers.
 * Used by the function getLocaleNumberFormat.
 */
 ...
 * See NumberSymbol for more information.
 */
...
function checkFullData(data: any) {
  if (!data[LocaleDataIndex.ExtraData]) {
    throw new Error(
        `Missing extra locale data for the locale "${data[LocaleDataIndex.LocaleId]}".`);
  }
}
 ...
 * You should use the function getLocaleExtraDayPeriodRules to determine which period to
 * use.
