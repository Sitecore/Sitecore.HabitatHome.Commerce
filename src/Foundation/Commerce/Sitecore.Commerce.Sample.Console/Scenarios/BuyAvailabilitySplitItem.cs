    ...
    public static class BuyAvailabilitySplitItem
    {
        ...
        public static Task<string> Run(ShopperContext context)
        {
            ...
            try
            {
                ...
                //Add a backordered item
                Proxy.DoCommand(
                    container.AddCartLine(cartId, "Adventure Works Catalog|AW210 12|4", 1)
                );

                //Add a preordered item
                Proxy.DoCommand(
                    container.AddCartLine(cartId, "Adventure Works Catalog|AW074 04|9", 1)
                );
