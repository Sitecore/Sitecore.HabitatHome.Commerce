...
namespace Sitecore.HabitatHome.Foundation.Entitlements.Engine
{
    ...
    ///     </cref>
    /// </seealso>
    [PipelineDisplayName("EntityViewOrderDigitalItems")]
    public class EntityViewOrderDigitalItems : PipelineBlock<EntityView, EntityView, CommercePipelineExecutionContext>
    {
        ...
        public EntityViewOrderDigitalItems(CommerceCommander commerceCommander)
        {
        ...
        public override async Task<EntityView> Run(EntityView entityView, CommercePipelineExecutionContext context)
        {
            ...
            try
            {
                if (entityView.ChildViews.FirstOrDefault(p => p.Name == "OrderEntitlements") is EntityView orderEntitlementsView)
                {
