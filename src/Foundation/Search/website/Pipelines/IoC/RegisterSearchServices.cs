...
namespace Sitecore.HabitatHome.Foundation.Search.Pipelines.IoC
{
    public class RegisterSearchServices : IServicesConfigurator
    {
        public void Configure(IServiceCollection serviceCollection)
        {
            ...
            serviceCollection.AddSingleton<ISearchService, Sitecore.HabitatHome.Foundation.Search.Services.SearchService>();
