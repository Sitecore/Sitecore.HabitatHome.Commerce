...
namespace Sitecore.HabitatHome.Feature.EBay.Engine.EntityViews
{
    ...
    ///     </cref>
    /// </seealso>
    [PipelineDisplayName("DoActionRegisterToken")]
    public class DoActionRegisterToken : PipelineBlock<EntityView, EntityView, CommercePipelineExecutionContext>
    {
        private readonly CommerceCommander _commerceCommander;

        /// <summary>
        /// Initializes a new instance of the <see cref="DoActionRegisterToken"/> class.
        /// </summary>
        /// <param name="commerceCommander">The <see cref="CommerceCommander"/> is a gateway object to resolving and executing other Commerce Commands and other control points.</param>
        public DoActionRegisterToken(CommerceCommander commerceCommander)
        {
        ...
        public override async Task<EntityView> Run(EntityView entityView, CommercePipelineExecutionContext context)
        {
            ...
            if (entityView == null
                || !entityView.Action.Equals("Ebay-RegisterToken", StringComparison.OrdinalIgnoreCase))
            {
                return entityView;
            }
