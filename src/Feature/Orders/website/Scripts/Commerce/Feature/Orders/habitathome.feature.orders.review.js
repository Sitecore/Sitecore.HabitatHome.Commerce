...
(function (root, factory) {
    ...
    root.CheckoutConfirm_ComponentClass = "cxa-checkoutreview-component";

}(this, function (element) {
    'use strict';
    var component = new Component(element);
    component.Name = "CXA/Feature/CheckoutReview";
...
$(document).ready(function () {
    $("." + CheckoutConfirm_ComponentClass).first(function () {
