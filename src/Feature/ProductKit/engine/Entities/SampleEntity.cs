...
using Sitecore.HabitatHome.Feature.ProductKit.Engine.Components;

namespace Sitecore.HabitatHome.Feature.ProductKit.Engine.Entities
{
    /// <inheritdoc />
    /// <summary>
    /// SampleEntity model.
    ...
    public class SampleEntity : CommerceEntity
    {
        /// <inheritdoc />
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Sitecore.HabitatHome.Feature.ProductKit.Engine.Entities.SampleEntity" /> class.
        /// </summary>
        public SampleEntity()
        {
