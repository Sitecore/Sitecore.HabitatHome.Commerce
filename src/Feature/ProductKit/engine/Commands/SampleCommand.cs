...
using Sitecore.HabitatHome.Feature.ProductKit.Engine.Pipelines;
using Sitecore.HabitatHome.Feature.ProductKit.Engine.Pipelines.Arguments;

namespace Sitecore.HabitatHome.Feature.ProductKit.Engine.Commands
{
    /// <inheritdoc />
    /// <summary>
    ...
    public class SampleCommand : CommerceCommand
    {
        ...
        /// <inheritdoc />
        /// <summary>
        /// Initializes a new instance of the <see cref="T:Sitecore.HabitatHome.Feature.ProductKit.Engine.Commands.SampleCommand" /> class.
        /// </summary>
        /// <param name="pipeline">
        /// The pipeline.
        /// </param>
