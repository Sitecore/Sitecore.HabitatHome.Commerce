            ...
            if (!string.IsNullOrEmpty(cartId))
            {
                ...
                if (result.IsSuccessStatusCode)
                {
                    ...
                    {                        
                        ...
                        {
                            line.IsKit = lineItemProduct["Tags"] != null && !String.IsNullOrEmpty(lineItemProduct["Tags"]) ? lineItemProduct["Tags"].Split('|').Any(t => t.ToLower() == "kit") : false;
                            line.IsBundle = lineItemProduct["Tags"] != null && !String.IsNullOrEmpty(lineItemProduct["Tags"]) ? lineItemProduct["Tags"].Split('|').Any(t => t.ToLower() == "bundle") : false;
                        } 
