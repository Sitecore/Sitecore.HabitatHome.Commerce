...
namespace Sitecore.HabitatHome.Feature.WishLists.Pipelines
{
    public class WishListProcessor : PipelineProcessor
    {
        ...
        protected void Translate(Commerce.Plugin.Carts.Cart source, WishList destination)
        {            
            ...
            destination.Lines = this.TranslateLines(source, destination);
        }

        protected List<WishListLine> TranslateLines(Sitecore.Commerce.Plugin.Carts.Cart source, WishList destination)
        {
