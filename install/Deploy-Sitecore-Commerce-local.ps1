#Requires -Version 3
param(
    [string]$SiteName = "xc9demo.dev.local",	
	[string]$SiteHostHeaderName = "xc9demo.dev.local",	
	[string]$SqlDbPrefix = "xc9demo",
...
$params = @{
		...
		XConnectInstallDir = "$($Env:SYSTEMDRIVE)\inetpub\wwwroot\xc9demo_xconnect.dev.local"
...
# MTgwMTI3MTgzMjUwWjAjBgkqhkiG9w0BCQQxFgQUGnxgCSf5slNJdgLEge3PxWS4
# CsYwDQYJKoZIhvcNAQEBBQAEggEAmmXvFE4NDeXHR4uidOwraCNRJpRTy5xNP5sg
# u228MNuFGtyrFFGO1YOuBunaeLwKrWWLWNmELhMrt2kxPSQn56Zi7txwuF9yHeV4
# 5sxYJQEkfWgWPwbVwBsv4yjvZQep/lj3NLtuY0MZzT2kXJ/SKTMi6nhIWValSHtL
# 0v+7I6LmEYM2VFAkZu978w+T3tXQ9A5uKwycbOUg7rXLkIfSZti1hTXlAakOccf7
# qwfJ0EErGy313RezCIX5WDrhrdDgRLqFWqYusw5Pn6IChxC3vYaJR6olqO7pWZTb
# MkZdtHcEBaAtPJNQg1+aCy9MxyHZqoDRi6lxER+U22f/3cnSWA==
