...
(function (root, factory) {
    ...
    CXAApplication.CreateComponentInstane = function (cssSelector, callInitMethod, loadAll) {
        var $selectedObjects;
        ...
        console.log("CXAApplication.CreateComponentInstane...");
    ...
    CXAApplication.InitializeComponents = function () {
        CXAApplication.CreateComponentInstane("[data-cxa-component-class]", false, true);
        ...
        if (CXAApplication.IsExperienceEditorMode()) {
            if (typeof DomObserver === "undefined") {
                ...
                DomObserver.ObserveDomChanges(function () {
                    CXAApplication.CreateComponentInstane("[data-cxa-component-class]", true);
                }, $("#wrapper").get(0));
            }
        }
    };
