...
(function (root, factory) {
    ...
    //To be overriden with actual components
    ...
    component.Visual = {
        ...
        DisableLinks: function(){
            $(component.RootElement).find('a').attr('href', 'javascript:void(0)');
        },
        Disable: function () {
            $(component.RootElement).find('input').attr('disabled', 'disabled');
            $(component.RootElement).find('select').attr('disabled', 'disabled');
            $(component.RootElement).find('textarea').attr('disabled', 'disabled');
            $(component.RootElement).find('button').attr('disabled', 'disabled');
            $(component.RootElement).find('a').attr('disabled', 'disabled');
        ...
        Enable: function () {
            $(component.RootElement).find('input').removeAttr('disabled');
            $(component.RootElement).find('button').removeAttr('disabled');
        }
    };
