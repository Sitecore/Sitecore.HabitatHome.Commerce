    ...
    SearchServiceModel = Backbone.Model.extend({
        ...
        getSearchResultsData: function(overrideProps) {
            ...
            _.each(searchResultsModels, function (searchModel) {
                ...
                signature = searchModel.get('dataProperties').sig !== null ? encodeURIComponent(searchModel.get('dataProperties').sig) : '',
        ...
        getSortOrder: function(signature, mergedProps, searchResultsDefaultSortOrder) {
            ...
            if (!mergedProps.hasOwnProperty(paramName)) {
                ...
                if (firstSortingOption !== -1) {
                    mergedProps[paramName] = firstSortingOption;
                    obj[paramName] = firstSortingOption;
                } else if (searchResultsDefaultSortOrder !== "") {
                    mergedProps[paramName] = searchResultsDefaultSortOrder;
                    obj[paramName] = searchResultsDefaultSortOrder;
                }
            }

            if (!_.isEmpty(obj)) {
                queryModel.updateHash(obj);
            }
