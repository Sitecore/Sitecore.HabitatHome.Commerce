...
(function (root, factory) {
    ...
    function notifyHandler(handler, source, priceBefore, price, isOnSale, savingsMessage, data) {
        handler(source, priceBefore, price, isOnSale, savingsMessage, data);
    }

    function dispatch(source, priceBefore, price, isOnSale, savingsMessage, data) {
        var handlers = ProductPriceContext.Handlers;

        var handlerId;
        for (handlerId in handlers) {
            if (handlers.hasOwnProperty(handlerId)) {
                notifyHandler(handlers[handlerId], source, priceBefore, price, isOnSale, savingsMessage, data);
            }
        }
    }
