...
function ProductListViewModel() {
    ...
    self.loadProducts = function () {
        ...
        AjaxService.Post("/api/cxa/Catalog/GetProductList",params, function (data, success, sender) {
    ...
    function addMoreProducts(data) {
        ...
        self.canLoadMoreProducts(data.ChildProducts && (data.ChildProducts.length >= currentPageSize));
    };
