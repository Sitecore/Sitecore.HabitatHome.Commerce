...
(function (root, factory) {
    ...
    component.ProductPriceSetPriceHandler = function (source, priceBefore, price, isOnSale, savingsMessage, data) {
        component.priceInfoVM.switchInfo(priceBefore, price, isOnSale, savingsMessage);
    };
    ...
    component.Init = function () {
        $(component.RootElement).find(".price-info").each(function () {
            component.priceInfoVM = new PriceInfoViewModel();
            ...
            if (CXAApplication.IsExperienceEditorMode()) {
                component.ProductPriceSetPriceHandler("MockData", "14.95 USD", "12.95 USD", "true", "- Save up to  13%");
            }
        });
    };
