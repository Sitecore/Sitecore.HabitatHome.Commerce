...
function AddressEditorViewModel(data, accountPageUrl, addressId, rootElementRef) {
    ...
    self.saveAddress = function () {
        ...
        if (self.address.errors().length === 0) {
            ...
            AjaxService.Post("/api/cxa/Account/AddressEditorModify", address, function (data, success, sender) {
                if (data.Success) {
                    self.reload(data);
    ...
    self.deleteAddress = function () {
        ...
        AjaxService.Post("/api/cxa/Account/AddressEditorDelete", { addressId: self.address().externalId() }, function (data, success, sender) {
            self.reload(data);
